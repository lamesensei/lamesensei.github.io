...
const Title = tw.h5`flex items-center`;
const TitleString = tw.span`inline-block font-extrabold tracking-wide text-gray-800 text-lg mr-3`;
const DateString = tw.span`inline-block sm:inline font-thin text-sm font-mono text-gray-600 tracking-tight`;
